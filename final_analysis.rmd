...
The data file `GSE127221_PBMC_merged_filtered_recoded.rds` contaings sequencing data that was aligned and converted to UMI counts with the inDrop pipeline.  Barcodes were filtered to retain only cells with at least 500 unique counts.
...
Figure 5 presents flow cytometric analysis of a validation set of patient 
samples. No single cell RNASeq data is presented in figure 5. Supporting 
data for figure 5 is available from the authors upon request.
